        ...
        <ul class="sidebar-nav">
            ...
            @can('access-sales-production')
                <li class="sidebar-item ">
                    <a data-bs-target="#" href="{{ route('sales-production.index') }}" class="sidebar-link">
                        <i class="align-middle me-2 fas fa-fw fa-calendar"></i><span class="align-middle">Sales Production
                            Scheduler</span>
                    </a>
                </li>
            @endcan
            ...
            @can('fix-issues')
                <li class="sidebar-item ">
                    <a data-bs-target="#" href="{{ route('maintenance-schedule.index') }}" class="sidebar-link">
                        <i class="align-middle me-2 fas fa-fw fa-calendar"></i><span class="align-middle">Maintenance
                            Scheduler</span>
                    </a>
                </li>
            @endcan
            ...
            <li class="sidebar-item">
                ...
                <ul id="reports"
                    ...
                    @endcanany
                    @can('fix-issues')
                        <li @if (Route::is('engineers.*')) class="sidebar-item active" @else class="sidebar-item" @endif>
                            <a class="sidebar-link" href="{{ route('engineers.index') }}"> <i
                                    class="align-middle me-2 fas fa-clipboard-check"></i> <span
                                    class="align-middle">Engineer/IT Logs</span></a></li>
                    @endcan
                    @canany(['access-editor_logs', 'access-editor_logs-readonly'])
                        <li
                            @if (Route::is('editors.*')) class="sidebar-item active" @else class="sidebar-item" @endif>
                            <a class="sidebar-link" href="{{ route('editors.index') }}"> <i
                    ...
                    @canany(['access-ob_logs', 'access-ob_logs-readonly'])
                        <li
                            @if (Route::is('oblogs.*')) class="sidebar-item active" @else class="sidebar-item" @endif>
                            <a class="sidebar-link" href="{{ route('oblogs.index') }}"> <i
                    ...
                    @canany(['access-production_show_logs', 'access-production_show_logs-readonly'])
                        <li
                            @if (Route::is('production.*')) class="sidebar-item active" @else class="sidebar-item" @endif>
                            <a class="sidebar-link" href="{{ route('production.index') }}"> <i
                                    class="align-middle me-2 fas fa-tag"></i> <span class="align-middle">Production Show
                                    Logs</span></a></li>
                    @endcanany
                    @canany(['access-ob_logs', 'access-ob_logs-readonly'])
                        <li
                            @if (Route::is('graphics-news.*')) class="sidebar-item active" @else class="sidebar-item" @endif>
                            <a class="sidebar-link" href="{{ route('graphics-news.index') }}"> <i
                                    class="align-middle me-2 fas fa-file-alt"></i> <span class="align-middle">Graphics
                                    Logs (News)</span></a></li>
                        <li
                            @if (Route::is('graphics.*')) class="sidebar-item active" @else class="sidebar-item" @endif>
                            <a class="sidebar-link" href="{{ route('graphics-shows.index') }}"> <i
                                    class="align-middle me-2 fas fa-file-alt"></i> <span class="align-middle">Graphics
                    ...
                    @canany(['access-prompter_logs', 'access-prompter_logs-readonly'])
                        <li
                            @if (Route::is('prompter-news.*')) class="sidebar-item active" @else class="sidebar-item" @endif>
                            <a class="sidebar-link" href="{{ route('prompter-news.index') }}"> <i
                                    class="align-middle me-2 fas fa-file-alt"></i> <span class="align-middle">Prompter
                                    Logs (News)</span></a></li>
                        <li
                            @if (Route::is('prompter-shows.*')) class="sidebar-item active" @else class="sidebar-item" @endif>
                            <a class="sidebar-link" href="{{ route('prompter-shows.index') }}"> <i
                                    class="align-middle me-2 fas fa-file-alt"></i> <span class="align-middle">Prompter
                                    Logs (Shows)</span></a></li>
                    @endcanany
