                        ...
                        <div class="card" style="background-color: #0c0c0cd6;">
                            <div class="card-body">
                                <div class="m-sm-4">
                                    ...
                                    <h5 class="text-center mb-3" style="color:#fff;">{{ __('Forgot your password?') }}</h5>
                                    <p class="text-center mb-4" style="color:#aaa; font-size:.85rem;">
                                    ...
                                    <form method="POST" action="{{ route('password.email') }}">
                                        ...
                                        <div class="text-center mt-3">
                                            <a href="{{ route('login') }}" style="color:#aaa; font-size:.85rem;">{{ __('Back to login') }}</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
