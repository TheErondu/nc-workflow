        ...
        <div class="row">
            <div class="col-12">
                <div class="card-opaque">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('store.update', $store_item->id) }}">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="row justify-content-around">
                                <div class="mb-3 col-md-8">
                                    ...
                                    <input name="item_name" type="text" class="form-control" id="item_name"
                                        value="{{ $store_item->item_name }}" required placeholder="">
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-around">
                                <div class="mb-3 col-md-8">
                                    ...
                                    <input name="serial_no" type="text" class="form-control" id="serial_no"
                                        value="{{ $store_item->serial_no }}" required placeholder="">
                                </div>
                                    ...
                                    <div class="mb-3 col-md-8">
                                        ...
                                        <select class="form-control select2" name="assigned_department" id="assigned_department">
                                            @foreach ($departments as $department)
                                                <option value="{{ $department->name }}" @if($store_item->assigned_department === $department->name) selected='selected' @endif>{{ $department->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <form action="{{ route('store.destroy', $store_item->id) }}" id="delete-form" method="POST">
                                @method('DELETE')
                                @csrf
