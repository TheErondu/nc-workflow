        ...
        <div class="col-12">
            <div class="card table-card">
                <div class="card-header" style="margin-bottom: 1.0rem;">
                    ...
                    class="btn btn-primary create-button">Add New Log <i class="fas fa-plus"></i></a>&nbsp;&nbsp;<a href="{{route('production.index')}}" style="background-color: rgb(0, 0, 0) !important;" type="submit"
