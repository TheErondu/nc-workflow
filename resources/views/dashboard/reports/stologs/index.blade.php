@extends('layouts.app', ['activePage' => 'sto-logs', 'titlePage' => __('STO Logs')])
@section('content')
            ...
            <div class="col-12">
                <div class="card-opaque">
                    <div class="card-header" style="margin-bottom: 1.0rem;">
                        <span>STO Logs</span>
                        <a href="{{ route('sto-logs.create') }}" style="background-color: rgb(0, 0, 0) !important;"
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var calendar = new FullCalendar.Calendar(calEl, {
            ...
            eventSources: [{
                url: '/api/stologs-calendar/',
                method: 'GET',
            }],
            eventClick: function(info) {
                info.jsEvent.preventDefault();
                window.location.href = "{{ url('logs/sto') }}/" + info.event.id + "/edit";
            },
