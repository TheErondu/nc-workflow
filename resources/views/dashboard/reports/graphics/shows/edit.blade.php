        ...
        <div class="row">
            <div class="col-12">
                <div class="card-opaque">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('graphics-shows.update',$graphics_log_shows->id) }}">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select class="form-control select2" name="director" id="director" data-placeholder=" select director">
                                        ...
                                        @foreach($users as $user)
                                            <option value="{{ $user->name }}" @if($graphics_log_shows->director === $user->name) selected='selected' @endif>{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3 col-md-4">
                            ...
                            <div class="row justify-content-center">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select class="form-control select2" name="engineer" id="engineer" data-placeholder=" select engineer ">
                                        <option value="" selected>select</option>
                                        @foreach($users as $user)
                                            <option value="{{ $user->name }}" @if($graphics_log_shows->engineer === $user->name) selected='selected' @endif>{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="row justify-content-around">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select class="form-control select2" name="director2" id="director2" data-placeholder=" select director">
                                        <option value="" selected>select</option>
                                        @foreach($users as $user)
                                            <option value="{{ $user->name }}" @if($graphics_log_shows->director2 === $user->name) selected='selected' @endif>{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3 col-md-4">
                            ...
                            <div class="row justify-content-center">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select class="form-control select2" name="engineer2" id="engineer2" data-placeholder=" select engineer ">
                                        <option value="" selected>select</option>
                                        @foreach($users as $user)
                                            <option value="{{ $user->name }}" @if($graphics_log_shows->engineer2 === $user->name) selected='selected' @endif>{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3 col-md-8">
                            ...
                            <div class="row justify-content-around">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select class="form-control select2" name="director3" id="director3" data-placeholder=" select director">
                                        <option value="" selected>select</option>
                                        @foreach($users as $user)
                                            <option value="{{ $user->name }}" @if($graphics_log_shows->director3 === $user->name) selected='selected' @endif>{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3 col-md-4">
                            ...
                            <div class="row justify-content-center">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select class="form-control select2" name="engineer3" id="engineer3" data-placeholder=" select engineer ">
                                        <option value="" selected>select</option>
                                        @foreach($users as $user)
                                            <option value="{{ $user->name }}" @if($graphics_log_shows->engineer3 === $user->name) selected='selected' @endif>{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3 col-md-8">
                            ...
                            <div class="row justify-content-around">
                                <div class="mb-3 col-md-3">
                                    <span>Uploaded by: <br> {{$graphics_log_shows->user->name }}</span>
                                </div>
                                <div class="mb-3 col-md-3">
                                    <span>Uploaded at: <br> {{ $graphics_log_shows->created_at}}</span>
                                </div>
                            </div>
                    ...
                    <form action="{{ route('graphics-shows.destroy', $graphics_log_shows->id) }}" id="delete-form" method="POST">
                        @method('DELETE')
                        @csrf
