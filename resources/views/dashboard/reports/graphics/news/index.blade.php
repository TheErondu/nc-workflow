            ...
            <div class="col-12">
                <div class="card-opaque">
                    <div class="card-header" style="margin-bottom: 1.0rem;">
                        <span>Graphics News Logs </span>
                        <a href="{{route('graphics-news.create')}}" style="background-color: rgb(0, 0, 0) !important;" type="submit"
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                var calendar = new FullCalendar.Calendar(ProdCal, {
                    ...
                    eventSources: [
                        ...
                        // your event source
                        {
                            url: '/api/graphics-news-calendar/',
                            method: 'GET',
                            id: 'id',
                            title: 'title',
                            start: 'start',
                    ...
                    eventClick: function(info) {
                        window.location = "/logs/graphics-news/" + info.event.id + "/edit";
