            ...
            <div class="card table-card">
                ...
                <div class="card">
                    <div class="card-body card-black">
                      <p>No Logs Have Been Added yet, Click  <a href="{{ route('graphics-news.create') }}" data-toggle="tooltip" title="" data-original-title="Add Report">Here</a> to add Logs<p>
                    <p><a class="btn btn-primary" href="{{ route('graphics-news.create') }}">Add a Log</a>
                    </p>
                </div>
                    </div>
                @endif
