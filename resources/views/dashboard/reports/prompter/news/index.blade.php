            ...
            <div class="card table-card">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered datatable dtr-inline" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                    <td><a href="{{route('prompter-news.edit',
                ...
                <div class="card">
                    <div class="card-body card-black">
                      <p>No Logs Have Been Added yet, Click  <a href="{{ route('prompter-news.create') }}" data-toggle="tooltip" title="" data-original-title="Add Report">Here</a> to add Logs<p>
                    <p><a class="btn btn-primary" href="{{ route('prompter-news.create') }}">Add a Log</a>
                    </p>
                </div>
                    </div>
                @endif
