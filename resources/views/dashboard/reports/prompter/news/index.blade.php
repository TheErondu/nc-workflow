            ...
            <div class="col-12">
                <div class="card-opaque">
                    <div class="card-header" style="margin-bottom: 1.0rem;">
                        <span>Prompter News Logs </span>
                        <a href="{{route('prompter-news.create')}}" style="background-color: rgb(0, 0, 0) !important;" type="submit"
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                var calendar = new FullCalendar.Calendar(ProdCal, {
                    ...
                    eventSources: [
                        ...
                        // your event source
                        {
                            url: '/api/prompter-news-calendar/',
                            method: 'GET',
                            id: 'id',
                            title: 'title',
                            start: 'start',
                    ...
                    eventClick: function(info) {
                        window.location = "/logs/prompter-news/" + info.event.id + "/edit";
