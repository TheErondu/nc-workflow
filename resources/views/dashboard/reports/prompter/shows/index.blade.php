        ...
        <div class="col-12">
            <div class="card table-card">
                <div class="card-header" style="margin-bottom: 1.0rem;">
                    ...
                    <a href="{{route('prompter-shows.create')}}" style="background-color: rgb(0, 0, 0) !important;" type="submit"
                ...
                @if (count($prompter_logs_shows) > 0)
                ...
                <div class="table-responsive">
                    <table class="table table-bordered datatable dtr-inline" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            @foreach ($prompter_logs_shows as $log)
                            <tr>
                                    <td><a href="{{route('prompter-shows.edit',
                ...
                <div class="card">
                    <div class="card-body card-black">
                      <p>No Logs Have Been Added yet, Click  <a href="{{ route('prompter-shows.create') }}" data-toggle="tooltip" title="" data-original-title="Add Report">Here</a> to add Logs<p>
                    <p><a class="btn btn-primary" href="{{ route('prompter-shows.create') }}">Add a Log</a>
                    </p>
                </div>
                    </div>
                @endif
