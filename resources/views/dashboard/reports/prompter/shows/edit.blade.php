        ...
        <div class="row">
            <div class="col-12">
                <div class="card-opaque">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('prompter-shows.update',$prompter_logs_shows->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row justify-content-around">
                                <div class="mb-3 col-md-4">
                                    ...
                                    value="{{ $prompter_logs_shows->host }}"  placeholder="">
                                </div>
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select class="form-control select2" name="director" id="director" data-placeholder=" select director">
                                        ...
                                        @foreach($users as $user)
                                            <option value="{{ $user->name }}" @if($prompter_logs_shows->director === $user->name) selected='selected' @endif>{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3 col-md-4">
                                    ...
                                    value="{{ $prompter_logs_shows->anchor }}"  placeholder="">
                                </div>
                                </div>
                            ...
                            <div class="row justify-content-around">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    value="{{ $prompter_logs_shows->graphics }}"  placeholder="">
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label for="producer">Producer</label>
                                    <input name="producer" type="text" class="form-control" id="producer"
                                    value="{{ $prompter_logs_shows->producer }}"  placeholder="">
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label for="pa">PA </label>
                                    <input name="pa" type="text" class="form-control" id="pa"
                                    value="{{ $prompter_logs_shows->pa }}"  placeholder="">
                                </div>
                            </div>
                            <div class="row justify-content-center">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select class="form-control select2" name="engineer" id="engineer" data-placeholder=" select engineer ">
                                        <option value="" selected>select</option>
                                        @foreach($users as $user)
                                            <option value="{{ $user->name }}" @if($prompter_logs_shows->engineer === $user->name) selected='selected' @endif>{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3 col-md-8">
                                    ...
                                    value=""  placeholder="">{{ $prompter_logs_shows->challenges }}</textarea>
                                </div>
                            </div>
                            <div class=" row justify-content-center">
                                <div class="mb-3 col-md-4">
                            ...
                            <div class="row justify-content-around">
                                <div class="mb-3 col-md-4">
                                    ...
                                    value="{{ $prompter_logs_shows->host2 }}"  placeholder="">
                                </div>
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select class="form-control select2" name="director2" id="director2" data-placeholder=" select director">
                                        <option value="" selected>select</option>
                                        @foreach($users as $user)
                                            <option value="{{ $user->name }}" @if($prompter_logs_shows->director2 === $user->name) selected='selected' @endif>{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label for="anchor2">Anchor </label>
                                        ...
                                        value="{{ $prompter_logs_shows->anchor2 }}"  placeholder="">
                                    </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select class="form-control select2" name="engineer2" id="engineer2" data-placeholder=" select engineer ">
                                        <option value="" selected>select</option>
                                        @foreach($users as $user)
                                            <option value="{{ $user->name }}" @if($prompter_logs_shows->engineer2 === $user->name) selected='selected' @endif>{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3 col-md-8">
                                    ...
                                    value=""  placeholder="">{{ $prompter_logs_shows->challenges2 }}</textarea>
                                </div>
                            </div>
                            {{-- <div class=" row justify-content-center">
                                <div class="mb-3 col-md-4">
                            ...
                            <div class="row justify-content-around">
                                <div class="mb-3 col-md-4">
                                    ...
                                    value="{{ $prompter_logs_shows->host3 }}"  placeholder="">
                                </div>
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select class="form-control select2" name="director3" id="director3" data-placeholder=" select director">
                                        <option value="" selected>select</option>
                                        @foreach($users as $user)
                                            <option value="{{ $user->name }}" @if($prompter_logs_shows->director3 === $user->name) selected='selected' @endif>{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select class="form-control select2" name="anchor3" id="anchor3" data-placeholder=" select anchor">
                                        <option value="" selected>select</option>
                                        @foreach($users as $user)
                                            <option value="{{ $user->name }}" @if($prompter_logs_shows->anchor3 === $user->name) selected='selected' @endif>{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select class="form-control select2" name="engineer3" id="engineer3" data-placeholder=" select engineer ">
                                        <option value="" selected>select</option>
                                        @foreach($users as $user)
                                            <option value="{{ $user->name }}" @if($prompter_logs_shows->engineer3 === $user->name) selected='selected' @endif>{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3 col-md-8">
                                    ...
                                    value=""  placeholder="">{{ $prompter_logs_shows->challenges3 }}</textarea>
                                </div>
                            </div> --}}
                            <div class="row justify-content-around">
                                <div class="mb-3 col-md-3">
                                    <span>Uploaded by: <br> {{$prompter_logs_shows->user->name }}</span>
                                </div>
                                <div class="mb-3 col-md-3">
                                    <span>Uploaded at: <br> {{ $prompter_logs_shows->created_at}}</span>
                                </div>
                            </div>
                            <div class="row justify-content-between">
                                ...
                                <div class="mb-3 col-md-4">
                                    <a href="{{ route('prompter-shows.index') }}"
                    ...
                    <form action="{{ route('prompter-shows.destroy', $prompter_logs_shows->id) }}" id="delete-form" method="POST">
                        @method('DELETE')
                        @csrf
