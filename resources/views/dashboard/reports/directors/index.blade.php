        ...
        <div class="col-12">
            <div class="card table-card">
                <div class="card-header" style="margin-bottom: 1.0rem;">
                    ...
                    class="btn btn-primary create-button">Add New Log <i class="fas fa-plus"></i></a>&nbsp;&nbsp;<a href="{{route('reports.index',['view' => 'calendar'])}}" style="background-color: rgb(0, 0, 0) !important;" type="submit"
                    class="btn btn-primary">Switch to Calendar view <i class="fas fa-cog"></i></a>
                </div>
                <div class="row">
