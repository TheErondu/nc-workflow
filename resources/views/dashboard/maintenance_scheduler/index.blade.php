...
@section('content')
    ...
    <script src="https://unpkg.com/popper.js/dist/umd/popper.min.js"></script>
        ...
        <script>
            ...
            var tis=info.el;
            var tooltip = '<div class="tooltipevent" style="top:'+($(tis).offset().top-5)+'px;left:'+($(tis).offset().left+($(tis).width())/2)+'px"><div>' + info.event.title + '</div><div>' + info.event.extendedProps.notes + '</div><div>Status:' + info.event.extendedProps.status + '</div></div>';
