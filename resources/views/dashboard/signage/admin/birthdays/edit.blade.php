        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('signage.birthdays.update', $slide) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input name="celebrant_name" type="text" class="form-control" id="celebrant_name"
                                        placeholder="Enter celebrant's name" value="{{ old('celebrant_name', $slide->celebrant_name) }}" required>
                                </div>
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input name="birthday_date" type="date" class="form-control" id="birthday_date"
                                        value="{{ old('birthday_date', $slide->birthday_date ? $slide->birthday_date->format('Y-m-d') : '') }}" required>
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-3">
                                    ...
                                    <div>
                                        <img src="{{ $slide->image_url }}" alt="{{ $slide->celebrant_name }}"
                                ...
                                <div class="mb-3 col-md-5">
                                    ...
                                    <small class="text-muted">Leave empty to keep current photo. Max 5MB.</small>
                                </div>
