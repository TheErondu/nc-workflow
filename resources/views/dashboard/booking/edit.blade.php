                        ...
                        <form method="POST" enctype="multipart/form-data" action="{{ route('booking.store') }}">
                            ...
                            <div class="row justify-content-between">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input id="title" value="{{$booking->title}}" name="title" class="form-control" placeholder="Short Title" required type="text">
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label class="form-label">Date</label>
                                    <div class="input-group date" id="datetimepicker-minimum" data-target-input="nearest">
                                        <input name="date" value="{{$booking->date}}" type="text" class="form-control datetimepicker-input" data-target="#datetimepicker-minimum" />
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <div class="input-group date" id="datetimepicker-minimum2" data-target-input="nearest">
                                        <input name="start_time" value="{{$booking->start}}" type="text" class="form-control datetimepicker-input" data-target="#datetimepicker-minimum2" />
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <div class="input-group date" id="datetimepicker-minimum3" data-target-input="nearest">
                                        <input name="end_time" type="text" value="{{$booking->end}}" class="form-control datetimepicker-input" data-target="#datetimepicker-minimum3" />
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea name="description" class="form-control" rows="2"
                                        placeholder="Enter short briefing of  the Meeting Details ....">{{$booking->description}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="mb-3 col-md-6">
                                    <a href="{{route('booking.index', ['type'=>'studio']) }}" style="background-color: rgb(53, 54, 55) !important;"
                                        class="btn btn-primary">Cancel</a>
                                </div>
                                @elseif (request()->query("type") === 'boardroom' )
                                <div class="mb-3 col-md-6">
                                    <a href="{{route('booking.index', ['type'=>'boardroom']) }}" style="background-color: rgb(53, 54, 55) !important;"
                                        class="btn btn-primary">Cancel</a>
                                </div>
                                @else
                                <div class="mb-3 col-md-6">
                                    <a href="{{url()->previous() }}" style="background-color: rgb(53, 54, 55) !important;"
                                        class="btn btn-primary">Cancel</a>
                                </div>
                                @endif
