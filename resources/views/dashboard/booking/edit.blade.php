                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <div class="input-group date" id="datetimepicker-minimum2" data-target-input="nearest">
                                        <input name="start" value="{{$booking->start}}" type="text" class="form-control datetimepicker-input" data-target="#datetimepicker-minimum2" />
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <div class="input-group date" id="datetimepicker-minimum3" data-target-input="nearest">
                                        <input name="end" type="text" value="{{$booking->end}}" class="form-control datetimepicker-input" data-target="#datetimepicker-minimum3" />
