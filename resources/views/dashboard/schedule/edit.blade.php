                        ...
                        <form method="POST" enctype="multipart/form-data" action="{{ route('schedule.update', $schedule->id) }}">
                            ...
                            <div class="row">
                                <div class="mb-3">
                                    ...
                                    <input name="title" value="{{ $schedule->title }}" type="text" class="form-control" id="title" placeholder="title">
                                </div>
                            </div>
                            <div class="row justify-content-between">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <div class="input-group date" id="datetimepicker-minimum" data-target-input="nearest">
                                        <input name="start" value= "{{ $schedule->start }}" type="text" class="form-control datetimepicker-input" data-target="#datetimepicker-minimum" />
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <div class="input-group date" id="datetimepicker-minimum2" data-target-input="nearest">
                                        <input name="end" value= "{{ $schedule->end }}" type="text" class="form-control datetimepicker-input" data-target="#datetimepicker-minimum2" />
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea name="description" type="text" class="form-control" id="description" placeholder="">{{ $schedule->description }}</textarea>
                                </div>
                            </div>
