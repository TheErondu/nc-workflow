        ...
        <div class="row">
            <div class="col-12">
                <div class="card-opaque">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('sales-production.store') }}">
                            @csrf
                            <div class="row justify-content-between">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input name="client_name" type="text" class="form-control" id="client_name" placeholder="Client Name">
                                </div>
                                <div class="mb-3 col-md-4">
                                    <label for="sales_exec_ext">Sales Exec Ext.</label>
                                    <input name="sales_exec_ext" type="text" class="form-control" id="sales_exec_ext" placeholder="Sales Exec. Ext.">
                                </div>
                            </div>
                            <div class="row justify-content-between">
                                <div class="mb-3 col-md-4">
                                    <label for="client_cell">Client Cell</label>
                                    <input name="client_cell" type="text" class="form-control" id="client_cell" placeholder="Client Cell.">
                                </div>
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input name="brief_in_time" type="text" class="form-control" id="brief_in_time" placeholder="Brief In Time ">
                                </div>
                            ...
                            <div class="row justify-content-between">
                                <div class="mb-3 col-md-4">
                                 ...
                                 <div class="mb-3 col-md-4">
                                    ...
                                    <input name="sales_exec_name" type="text" class="form-control" id="sales_exec_name" placeholder="Sales Exec Name ">
                                 </div>
                                 <div class="mb-3 col-md-4">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea name="production_requirements" class="form-control" rows="2"
                                        placeholder="Enter Production Requirements Details ...."></textarea>
                                </div>
                            </div>
                            <div class="row justify-content-between">
                            <div class="mb-3 col-md-4">
