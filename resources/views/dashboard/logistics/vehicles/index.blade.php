                        ...
                        <table class="table table-bordered datatable dtr-inline" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                @foreach ($vehicles as $vehicle)
                                    <tr>
                                        <td><a href="{{ route('vehicles.edit', $vehicle->id) }}"><i
                                        ...
                                        <td class="pl-3"> <a data-toggle="modal" id="smallButton"
                                                data-target="#smallModal" data-attr="{{ route('delete', $vehicle->id) }}"
                    ...
                    @else
                        <div class="card">
                            <div class="card-body card-black">
                                <p>No Vehicles Have Been Added yet, Click <a href="{{ route('vehicles.create') }}"
                                        data-toggle="tooltip" title="" data-original-title="Add Vehicles">Here</a> to add
                                    vehicles and Assign them to a Driver
                                <p>
