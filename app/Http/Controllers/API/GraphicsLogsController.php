...
class GraphicsLogsController extends ApiController
{
    /**
    ...
    {
        $graphics_logs = DB::table('graphics_logs')->orderBy('created_at','desc')->get();
        return response()->json( compact('graphics_logs'));
    }
