...
class GraphicsLogShowsController extends ApiController
{
    /**
    ...
    {
        $graphics_log_shows = DB::table('graphics_log_shows')->orderBy('created_at','desc')->get();
        return response()->json( compact('graphics_log_shows'));
    }
