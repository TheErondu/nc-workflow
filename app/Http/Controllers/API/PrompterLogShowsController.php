...
class PrompterLogShowsController extends ApiController
{
    /**
    ...
    {
        $prompter_log_shows = DB::table('prompter_log_shows')->orderBy('created_at','desc')->get();
        return response()->json(compact('prompter_log_shows'));
    }
